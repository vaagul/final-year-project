...
def main():
   ...
   parser.add_argument('--weights', type=str, default='../models/mlp_num_hidden_units_1024_num_hidden_layers_3_epoch_79.hdf5')
   ...
   while q:
       ...
       print(type(VGGfeatures))
       #X_i = np.reshape((VGGfeatures), (-1, 4096))
       X_i1=VGGfeatures.flatten()	
       X_i1.resize(4096)
       X_i=np.reshape(X_i1,(1,-1))
       print(X_i.shape)
       X = [X_q, X_i]
       y_predict =model.predict_classes(X_i, verbose=0)
